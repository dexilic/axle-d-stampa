...
function findKioskByCodeCompleted(msg) {
    ...
    if (msg.d.length == 1) {
        ...
        alert('U sistemu je pronadeno ' + msg.d.length + ' kioska sa istom šifrom.\r\nObavestite administratora sistema.');
    }
}
...
function getInfoWindowContent(kiosk) {
    ...
    //                          '<tr>' +
    //                            '<td>' +
    //                              '<img alt="ŠTAMPA KIOSK" title="ŠTAMPA KIOSK" src="' + imagesPath + 'BG932-116x100.jpg" style="border: 1px solid #000;" hspace="0" vspace="0" />' + 
    //                            '</td>' +
    //                            '<td>' +
    //                              '<img alt="ŠTAMPA KIOSK" title="ŠTAMPA KIOSK" src="' + imagesPath + 'Kucica-piktogram-116x100.gif" style="border: 1px solid #000;" hspace="0" vspace="0" />' +
    //                            '</td>' +
    //                          '</tr>' +
    //                        '</table>' +
    //                    '</div>' +
